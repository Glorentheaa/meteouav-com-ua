        ...
        <div className="bg-white dark:bg-slate-800 border border-slate-300 dark:border-slate-700 rounded-xl shadow-sm mt-2 flex flex-col overflow-hidden">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 divide-y md:divide-y-0 md:divide-x divide-slate-200 dark:divide-slate-700">
            ...
            <div className="p-4 sm:p-5 flex flex-col gap-5">
              ...
              {/* Глибина та Деталізація */}
              <div className="flex flex-wrap gap-4">
                <div>
                  <label className="text-[10px] font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider mb-1.5 block">Глибина</label>
                  <div className="flex bg-slate-100 dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded p-0.5">
                    <button onClick={() => setDepth('24')} className={`px-3 py-1 text-xs font-medium rounded transition-colors ${depth === '24' ? 'bg-white dark:bg-slate-700 shadow-sm text-emerald-600 dark:text-emerald-400' : 'text-slate-600 dark:text-slate-400'}`}>24 год</button>
                    <button onClick={() => setDepth('48')} className={`px-3 py-1 text-xs font-medium rounded transition-colors ${depth === '48' ? 'bg-white dark:bg-slate-700 shadow-sm text-emerald-600 dark:text-emerald-400' : 'text-slate-600 dark:text-slate-400'}`}>48 год</button>
                  </div>
                </div>
                <div>
                  <label className="text-[10px] font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider mb-1.5 block">Деталізація</label>
                  <div className="flex bg-slate-100 dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded p-0.5">
                    <button onClick={() => setDetail('1')} className={`px-3 py-1 text-xs font-medium rounded transition-colors ${detail === '1' ? 'bg-white dark:bg-slate-700 shadow-sm text-emerald-600 dark:text-emerald-400' : 'text-slate-600 dark:text-slate-400'}`}>1 год</button>
                    <button onClick={() => setDetail('3')} className={`px-3 py-1 text-xs font-medium rounded transition-colors ${detail === '3' ? 'bg-white dark:bg-slate-700 shadow-sm text-emerald-600 dark:text-emerald-400' : 'text-slate-600 dark:text-slate-400'}`}>3 год</button>
                  </div>
                </div>
              </div>
