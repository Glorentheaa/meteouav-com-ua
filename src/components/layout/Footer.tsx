      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-4 flex flex-col items-center justify-center">
        ...
        <div className="flex flex-col sm:flex-row items-center gap-2 sm:gap-3">
          ...
          <p className="text-xs sm:text-sm text-slate-600 dark:text-slate-400 text-center">
            ...
            <Link
              to="/about"
              className="hover:text-emerald-600 dark:hover:text-emerald-400 transition-colors underline decoration-slate-400 dark:decoration-slate-600 underline-offset-4"
            >
              MeteoUAV
            </Link>
            .{' '}
