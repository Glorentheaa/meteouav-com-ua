...
export const Auth: React.FC = () => (
  <div className="w-full flex flex-col gap-6">
    <header className="border-b border-slate-300 dark:border-slate-800 pb-4">
      <h1 className="text-2xl font-bold text-slate-900 dark:text-white">Авторизація</h1>
      <p className="text-sm text-slate-600 dark:text-slate-400 mt-1">Вхід та реєстрація в системі.</p>
    </header>
